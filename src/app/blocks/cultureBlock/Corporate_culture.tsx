  ...
  return (
    <>
        ...
        <div className="wrap_wrap">
          ...
          <div className="rabota2">
            <div>
              ...
              <p>Мы высоко ценим наших сотрудников и стремимся сделать их день рождения особенным и запоминающимся. В честь этого события дарим специальный сертификат, который можно обменять на корпоративные подарки по выбору, а также можно выбрать подарок через чат-бот в нашем корпоративном магазине.</p>
            </div>
          </div>
        </div>
      </main>
      ...
      <div className="directorCard">
        <div>
          <p>
            Наша компания ориентирована на развитие и инновации. Мы всегда рады
            приветствовать новые таланты. Уверены, что успех зависит от людей,
            поэтому стремимся создавать условия для их профессионального и
            личностного развития.<br/> В компании вы сможете участвовать в проектах,
            вносить свои идеи и развивать собственные инициативы!<br/><br/>

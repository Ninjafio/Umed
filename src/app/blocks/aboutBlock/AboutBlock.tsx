    ...
    <>
      ...
      <div className="AboutBlock__video-wrapper">
        <div className="AboutBlock__video-txt-wrapper">
          ...
          Мы предлагаем вам виртуальный тур по ЮМЕД! Он поможет лучше понять инфраструктуру и возможности Уральского медицинского колледжа. Мы стараемся создавать все условия для комфортной и продуктивной работы. Особое внимание уделяем постоянному обновлению оборудования, чтобы вы всегда имели доступ к современным технологиям, которые делают рабочие процессы интересными и позволяют добиваться высоких результатов.
